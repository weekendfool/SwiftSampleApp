...
//    var changeKeyAToString = 0
//    var changeKeyIToString = 0
//    var changeKeyUToString = 0
//    var changeKeyEToString = 0
//    var changeKeyOToString = 0
    //実行されたかどうかの処理
...
//        print(inputEmojiVowel)
//        print(inputEmojiConsonant)
        //出力する絵文字を格納する配列をuserdefaultから引き出す処理
        let inputKeyUnicodeStringArray:[Int] = UserDefaults.standard.array(forKey: "inputKeyUnicodeArray") as! [Int]
//        var inputKeyUnicodeArray:[Int] = []
//        print(inputKeyUnicodeStringArray)
        //暗号化に使用するば母音を辞書に格納
