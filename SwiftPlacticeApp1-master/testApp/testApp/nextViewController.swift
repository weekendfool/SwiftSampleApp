...
class Hiragana {
    ...
    //ひらがなの母音と子音を辞書に入れておく
    var hiraganaVowelDic:[Int:Int] = [100:128037, 101:127814, 102:128081, 103:128657, 104:127817, 105:127754]
    var hiraganaConsonantDic:[Int:Int] = [110:128511, 111:128512, 112:128515, 113:128516, 114:128513, 115:128518, 116:128517, 117:128514, 118:129315, 119:9786, 120:128522, 121:128519, 122:128578, 123:128579, 124:128521, 125:128524, 126:128525, 127:129392]
    //実行されたかどうかの処理
    var changeCounter = 0
    ...
    func hiraganaToEmoji(inputHiragana:String) -> (changeCounter:Int, hiraganaToEmojiVowelNumber:Int, hiraganaToEmojiConsonantNumber:Int, hiraganaToEmojiConsonantString:String, hiraganaToEmojiVowelString:String) {
            //1文字ずつ初期化
            var vowel = 0
            var consonant = 0
            changeCounter = 0
            ...
            return (changeCounter, hiraganaToEmojiVowelNumber, hiraganaToEmojiConsonantNumber, hiraganaToEmojiConsonantString, hiraganaToEmojiVowelString)
        }
     ...
     //文字から絵文字への変換する処理関数
        func changeHiraganaToEmoji(vowel:Int, consonant:Int) {
            ...
            //絵文字から文字コードに復号するようの格納
            hiraganaToEmojiVowelNumber = (vowel)
            hiraganaToEmojiConsonantNumber = (consonant)
            //Unicodeから絵文字に変換したものを保存
            vowelView.append(UnicodeScalar(hiraganaVowelDic[vowel]!)!)
    ...
    func changeEmojiToHiragana(inputEmojiVowel:Int, inputEmojiConsonant:Int) -> String {
            ...
            switch (inputEmojiVowel, inputEmojiConsonant) {
                case (100, 110):
